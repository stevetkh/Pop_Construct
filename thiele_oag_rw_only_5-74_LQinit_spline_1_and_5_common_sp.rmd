...
#load(paste0("C:/Users/ktang3/Desktop/Imperial/Pop_Construct/thiele_RW_Gumbel_1_and_5_wrong_tips_and_priors/",params$country," tau Gumbel P1.RData"))
#load(paste0("C:/Users/ktang3/Desktop/Imperial/Pop_Construct/thiele_RW_Gumbel_1_and_5/",params$country," tau Gumbel.RData"))
#load(paste0("C:/Users/ktang3/Desktop/Imperial/Pop_Construct/thiele_RW_Gumbel_1_and_5_common_AR2/",params$country," tau Gumbel AR2.RData"))

#load(paste0("C:/Users/ktang3/Desktop/Imperial/Pop_Construct/thiele_RW_Gumbel_1_and_5_common_AR2_tighter_prior/",params$country," tau Gumbel AR2.RData"))

load(paste0("C:/Users/ktang3/Documents/",params$country," tau Gumbel common sp AR2 phi hiv var.RData"))

#load(paste0("C:/Users/ktang3/Desktop/Imperial/Pop_Construct/thiele_RW_Gumbel_1_and_5_common_AR2_all/",params$country," tau Gumbel AR2.RData"))
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "Estimated TiPS", out.height="0.3\\paperheight"}
if(length(unique(bf5.smooth$DHS)) == 1 || diff(as.numeric(str_extract(unique(bf5.smooth$DHS), "\\d+"))) > 14) {
  tp.all %>%
...
inner_join(mig.df, pop.df) %>% mutate(gx = mig/value, model = fct_relevel(model, "Thiele RW")) %>% filter(age %in% seq(0,70, by = 5)) %>%
  ...
  theme(text = element_text(size=25), legend.key.size = unit(1.5,"cm"), strip.text = element_text(size=30),
        plot.title = element_text(hjust = 0.5, face = "bold", size = 35)) +
  facet_wrap_paginate(~age, nrow=5, ncol=3, page=1)
...
mfr.df %>% filter(model != "Initial Values") %>%
  ...
  ggtitle(paste(country, "Mean Age at Birth")) +
  theme(text = element_text(size=25),
        plot.title = element_text(hjust = 0.5, face = "bold", size = 35),
        legend.key.width = unit(2,"cm")) 
```
