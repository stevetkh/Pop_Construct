...
__LogQuad__
```{r, echo=FALSE}
system.time(LQ.f.no0 <- fit_tmb(input.LQ.both.vec,inner_verbose=FALSE, outer_verbose=FALSE, random = c("log_basepop_f",
                                                                                 "log_fx",
                                                                                 "gx_f",
                                                                                 "tp_params",
                                                                                 "h_params_f",
...
__Thiele__
```{r, echo=FALSE}
system.time(thiele.f.no0 <- fit_tmb(input.LQ.both.vec,inner_verbose=FALSE, outer_verbose=FALSE, random = c("log_basepop_f",
                                                                                 "log_fx",
                                                                                 "gx_f",
                                                                                 "tp_params",
                                                                                 "log_phi_innov",
...
thiele.f.no0$message
```
__Thiele MVN__
```{r, echo=FALSE}
system.time(thiele.f.no0.MVN <- fit_tmb(input.LQ.both.vec,inner_verbose=FALSE, outer_verbose=FALSE, random = c("log_basepop_f",
                                                                                     "log_fx",
                                                                                     "gx_f",
                                                                                     "tp_params",
                                                                                     "log_phi_innov",
...
thiele.f.no0.MVN$message
```
__Thiele no DHS__
```{r, echo=FALSE}

system.time(thiele.f.noDHS <- fit_tmb(input.LQ.both.vec,inner_verbose=FALSE, outer_verbose=FALSE, random = c("log_basepop_f",
                                                                                     "log_fx",
                                                                                     "gx_f",
                                                                                     "log_phi_innov",
                                                                                     "log_psi_innov",
...
thiele.f.noDHS$message
```
__Thiele fix rho_gt=0__
```{r, echo=FALSE}
input.LQ.both.vec$par_init$logit_rho_g_t <- 0
system.time(thiele.f.fixgt <- fit_tmb(input.LQ.both.vec,inner_verbose=FALSE, outer_verbose=FALSE, random = c("log_basepop_f",
                                                                                       "log_fx",
                                                                                       "gx_f",
                                                                                       "tp_params",
                                                                                       "log_phi_innov",
...
thiele.f.fixgt$message
```

```{r, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.cap="Estimated Adult Mortality", fig.align='center', fig.dim=c(6*5,4*5)}
...
q4515.df %>% filter(sex!="male") %>%
  ggplot() + geom_line(aes(x = year, y = value, col = model, linetype = sex), lwd = 1.2) + ylab(bquote(""[45]*q[15])) +
  theme(text = element_text(size=25))

```

```{r, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.cap="Estimated Child Mortality", fig.align='center',fig.dim=c(6*5,4*5)}
...
```{r, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.cap ="Estimated Mortality Schedules", fig.align='center', fig.dim=c(6*5,4*5)}
...
```{r, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.cap="Estimated Population Counts", fig.align='center', fig.dim=c(6*4,8*4)}
...
```{r, include=FALSE, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.cap="Estimated Population Counts (Cohorts)", fig.align='center', fig.dim=c(6*5,4*5)}
...
```{r, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.cap="Estimated Migration Proportions", fig.align='center', fig.dim=c(6*5,4*5)}
#migration####
get.mig<- function(x){
...
```{r, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.cap="Estimated Fertility", fig.align='center', fig.dim=c(6*5,4*5)}
get.fert<- function(x){
