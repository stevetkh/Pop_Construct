...
```{r, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.cap="Estimated Population Counts (Cohorts)", fig.align='center', fig.dim=c(6*5,4*5)}
