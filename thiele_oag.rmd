...
data.loghump.vec.re <- list(log_basepop_mean_f = log(basepop.f), log_basepop_mean_m = log(basepop.m),
                         ...
                         pop_end = ifelse(apply(data.f, 2, function(i){length(na.omit(i))}) > 75/5 + 1, 75/5, apply(data.f, 2,
                                                                                                              function(i){length(na.omit(i))})-1),
...
```{r, echo=FALSE}
system.time(thiele.f.loghump.oag.RW.ori.re <- fit_tmb(input.thiele.loghump.oag.vec.RW.re,inner_verbose=TRUE, random = c("log_basepop_f","log_basepop_m",
                                                                                                              "log_fx",
                                                                                                              "gx_f","gx_m",
                                                                                                              "tp_params",
                                                                                                              "log_phi_f", "log_phi_m",
