...
Type objective_function<Type>::operator() ()
{
  ...
  DATA_SCALAR(theta_marginal_fx);
  DATA_SCALAR(theta_marginal_gx);

  DATA_SCALAR(theta_marginal_phi);
  DATA_SCALAR(theta_marginal_psi);
  DATA_SCALAR(theta_marginal_lambda);
  DATA_SCALAR(theta_marginal_delta);
  DATA_SCALAR(theta_marginal_epsilon);
  DATA_SCALAR(theta_marginal_A);
  DATA_SCALAR(theta_marginal_B);
  ...
  nll += SCALE(ARk(rho_vec), sigma_phi)(log_phi_m_spline_params) + SCALE(ARk(rho_vec), sigma_phi)(log_phi_f_spline_params);
  nll += SCALE(ARk(rho_vec), sigma_psi)(log_psi_m_spline_params) + SCALE(ARk(rho_vec), sigma_psi)(log_psi_f_spline_params);
  nll += SCALE(ARk(rho_vec), sigma_lambda)(log_lambda_m_spline_params) + SCALE(ARk(rho_vec), sigma_lambda)(log_lambda_f_spline_params);
  nll += SCALE(ARk(rho_vec), sigma_delta)(log_delta_m_spline_params) + SCALE(ARk(rho_vec), sigma_delta)(log_delta_f_spline_params);
  nll += SCALE(ARk(rho_vec), sigma_epsilon)(log_epsilon_m_spline_params) + SCALE(ARk(rho_vec), sigma_epsilon)(log_epsilon_f_spline_params);
  nll += SCALE(ARk(rho_vec), sigma_A)(log_A_m_spline_params) + SCALE(ARk(rho_vec), sigma_A)(log_A_f_spline_params);
  nll += SCALE(ARk(rho_vec), sigma_B)(log_B_m_spline_params) + SCALE(ARk(rho_vec), sigma_B)(log_B_f_spline_params);
  ...
  nll += SCALE(SEPARABLE( ARk(rho_vec), ARk(rho_vec) ), sigma_fx)(fx_spline_array);
