...
Type objective_function<Type>::operator() ()
{
  ...
  nll += SCALE(AR1(rho_lambda_f), sigma_lambda_f)(log_lambda_f - log_lambda_mean_f);  
  nll += SCALE(AR1(rho_delta_f), sigma_delta_f)(log_delta_f - log_delta_mean_f);  
  nll += SCALE(AR1(rho_epsilon_f), sigma_epsilon_f)(log_epsilon_f - log_epsilon_mean_f);  
  ...
  nll += SCALE(AR1(rho_lambda_m), sigma_lambda_m)(log_lambda_m - log_lambda_mean_m);  
  nll += SCALE(AR1(rho_delta_m), sigma_delta_m)(log_delta_m - log_delta_mean_m);  
  nll += SCALE(AR1(rho_epsilon_m), sigma_epsilon_m)(log_epsilon_m - log_epsilon_mean_m);  
